...
public class DebtRepaymentPlan {
    ...
    public static void main(String[] args) throws IOException {
        // 参数
        double monthlyExternalPayment = 16000; // 每月收入
        double mortgageMonthlyPayment = 3665; // 原等额本息月供
        String fileName = "Debt_Repayment_Plan-"+monthlyExternalPayment/1000+".xlsx";

        double externalDebt = 0; // 外债
...
//        double availableFunds = monthlyIncome - livingExpenses; // 14000 可用还款的资金
        ...
        while (mortgageRemaining > 0) {
            ...
            // 外债还款
            double externalPayment = externalRemaining > 0 ? Math.min(monthlyExternalPayment, (monthlyExternalPayment-mortgageMonthlyPayment)) : 0;
